...
\end{tabular}
\hline
\caption{\it Tempo de resposta das requisições ao banco de dados antes da otimização \label{before_stats}}
\end{table}
...
\end{tabular}
\hline
\caption{\it Tempo de resposta das requisições ao banco de dados após a otimização \label{after_stats}}
\end{table}
