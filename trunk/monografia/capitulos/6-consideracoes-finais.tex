...
% Comparação entre os algoritmos com nível de significância de 10%

% Recomendações de amigos/desconhecidos com pouca diferença

% deficiência na procura de produtos por parte dos usuários

% alguns tipos de recomendação podem ter indicado produtos óbvios

% amigos não tão conhecidos e desconhecidos não tão distantes
