...
\begin{itemize}
  ...
  \begin{itemize}
    \item Cultural
    \begin{description}
      \item[Político] Existe a possibilidade de usuários utilizarem o sistema para disseminar calúnias e difamações. Neste caso, os criadores do sistema podem ser responsabilizados legalmente pela exposição dessas informações.
