...
\begin{PstGanttChart}[yunit=2.5,xunit=3.5,ChartUnitIntervalName=Mês,
  ...
  \PstGanttTask[TaskOutsideLabel={Algoritmo de recomendação}]{2}{5}
  \PstGanttTask[TaskOutsideLabel={Capítulo Especificação}]{2}{5}
  ...
  \PstGanttTask[TaskOutsideLabel={Implantação do Front-End}]{6}{5}
